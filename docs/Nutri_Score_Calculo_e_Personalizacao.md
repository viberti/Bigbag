...
- **Falta (camada C1 live + E):** o sinal de **discordância entre fontes** ainda não é persistido no fusor (a confiança usa `nutricao_confirmada` como proxy); e uma **auditoria por foto/VLM** (camada E) para a taxa real de "plausível-errado".
