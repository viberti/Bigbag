...
- **Falta (camada F):** fundir A+C1+C2 num **score de confiança por EAN** que alimenta o §5 (nota só se mostra com confiança suficiente). E uma **auditoria por foto/VLM** (camada E) para a taxa real de "plausível-errado".
