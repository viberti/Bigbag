...
- **⚠ Lacuna de €/kg (investigada 2026-06-07):** **216/626 itens (34,5%) sem `preco_por_base`** — kg 60%, L 53%, un só 4%; **todos sem `linha_peso`**. Concentrado em lojas de desconto (Irmadona 83%, Mercadona 83%, Aldi) que imprimem **só o preço do pacote**, sem €/kg. Duas causas: (a) €/kg não está na nota → derivar do tamanho no nome ("MIRTILO 500"→500g) ou comparar por €/un; (b) Continente/Pingo onde o €/kg ESTÁ impresso mas a extração perdeu o peso → re-ler. Fix por decidir.
