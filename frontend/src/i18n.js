...
const STRINGS = {
  'pt-BR': {
    ...
    'nota.emAnalise': '📄 Recebi sua nota — estou lendo. Vai aparecer em "As minhas compras" daqui a pouco.',
    ...
    'lista.opcoes': '{n} {n|opção|opções}',
    'lista.costuma': 'costuma levar {n}',
    ...
    'menu.historico': 'Histórico de produtos',
    'menu.diag': 'Diagnóstico do scanner',
    'hist.title': 'Produtos consultados',
    'hist.vazio': 'Você ainda não consultou nenhum produto. Os que você abrir aparecem aqui.',
    'hist.falha': 'Não foi possível carregar o histórico.',
    'hist.hoje': 'hoje',
    'hist.ontem': 'ontem',
    'hist.haDias': 'há {n} dias',
    'hist.comparar': 'Comparar produtos',
    'hist.escolha': 'Escolha para comparar',
    'hist.escolha2': 'Marque ao menos 2',
    'hist.compararN': 'Comparar {n}',
    'hist.semCodigo': 'sem código de barras',
    'menu.buscarFoto': 'Buscar por foto',
    'match.title': 'Buscar por foto',
    'match.procurando': 'Procurando pela foto…',
    'match.qual': 'Qual destes é o produto?',
    'match.nada': 'Não encontrei nada parecido. Tente outra foto, mais de frente e com boa luz.',
    ...
    'scanner.identificarFoto': 'Identificar por foto',
    'scanner.identificando': 'A identificar pelas fotos…',
    'scanner.fotosTiradas': '{n} {n|foto|fotos} — tire também o rótulo nutricional e os ingredientes.',
    'scanner.maisFoto': 'Tirar outra foto',
    'scanner.maxFotos': 'Máximo {n} fotos',
    'scanner.identificarN': 'Identificar ({n})',
    'scanner.naoIdentificado': 'Não consegui identificar pelas fotos. Tente com o rótulo bem visível e boa luz.',
    'scanner.tentarFoto': 'Tirar outra foto',
