...
try {
  ...
  // Motor de gatilho (DRY-RUN): avalia os monitores de usuário contra o snapshot RECÉM-colhido e
  // grava alerta_log (entregue=0). Não envia nada — a entrega é a tarefa seguinte.
