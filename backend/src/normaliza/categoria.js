...
export const GRUPOS = [
  ...
  { id: 'higiene', t: ['higiene', 'hygiene', 'limpeza', 'cleaning', 'nao alimentar', 'detergente', 'detergent', 'papel', 'paper', 'cosmetic', 'sabonete', 'champo', 'beleza', 'lixivia', 'amaciador', 'champu', 'maquillaje', 'perfume', 'desodor', 'jabon', 'colonia', 'cabello', 'parafarmacia', 'guardanapo', 'servilleta'] },
