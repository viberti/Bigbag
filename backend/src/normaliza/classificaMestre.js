...
- QUEIJO: categoria="queijo" e a DENOMINAÇÃO (flamengo · mozzarella · gouda · cheddar · edam · emmental · fresco · curado · serra da estrela · ilha · brie · camembert · parmesao · gruyere) vai SEMPRE em "variedade" (nunca na categoria nem perdida). APRESENTAÇÃO (fatiado · ralado · bola · barra · porções) -> "apresentacao"; FONTE (cabra · ovelha · búfala; vaca=default) -> "fonte"; CURA (fresco · amanteigado · curado) -> "processamento". EXCEÇÕES com categoria própria (não "queijo"): requeijão · burrata · ricotta · mascarpone · queijo creme (Philadelphia).
