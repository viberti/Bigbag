...
const GRUPO_CAMPO = { obj: 'objetivos', cond: 'condicoes', diet: 'restricoes', pref: 'preferir', evit: 'evitar', nut: 'metas', sup: 'suplementos', med: 'medicacao', ativ: 'atividade_fisica' };
